            ...
            <div className="flex-1">
              ...
              <div className="bg-yellow-100 border border-yellow-300 rounded-lg p-3">
                <p className="text-yellow-800 text-sm font-medium">
                  ...
                  Please click on the <button onClick={() => setActiveTab('privacy')} className="font-bold text-red-600 underline hover:text-red-800 cursor-pointer bg-transparent border-none p-0">Privacy Policy</button> tab above to read our complete privacy policy and data handling practices.
                </p>
              </div>
            </div>
          </div>
