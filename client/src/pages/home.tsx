          ...
          <div className="flex space-x-3 min-w-max px-1 py-2">
            ...
            <button
              ...
              className={`flex items-center space-x-3 px-6 py-4 rounded-xl transition-all duration-200 hover:bg-opacity-90 active:scale-95 min-w-max border-2 ${
                activeTab === 'privacy' 
                  ? 'bg-gradient-to-r from-black to-gray-800 text-white shadow-xl border-gray-600 transform scale-105' 
                  : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50 hover:border-gray-400 shadow-lg'
              }`}
            >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
              ...
              <div className="p-6 space-y-6 max-h-96 overflow-y-auto">
                ...
                <div className="space-y-4">
                  <h3 className="text-xl font-semibold text-red-600">Information We Collect</h3>
                  <p className="text-gray-700 text-base leading-relaxed">
                  ...
                  <ul className="list-disc pl-6 space-y-1 text-gray-700 text-sm leading-relaxed">
                    <li>Device Information: Device type, operating system, browser type, and IP address (anonymized where possible).</li>
                    <li>Usage Data: Pages visited, session duration, and interaction data (e.g., button clicks), collected anonymously.</li>
                    <li>Local Storage Data: Cached data for offline access via service workers, stored locally on your device.</li>
                  </ul>
                  <p className="text-gray-700 text-base leading-relaxed">
                ...
                <div className="space-y-4">
                  <h3 className="text-xl font-semibold text-red-600">How We Use Your Information</h3>
                  <p className="text-gray-700 text-base leading-relaxed">
                ...
                <div className="space-y-4">
                  <h3 className="text-xl font-semibold text-red-600">Sharing and Disclosure of Information</h3>
                  <p className="text-gray-700 text-base leading-relaxed">
                  ...
                  <ul className="list-disc pl-6 space-y-1 text-gray-700 text-sm leading-relaxed">
                    <li>Service Providers: Third-party analytics tools (currently none in use) to process usage data, contractually bound to maintain confidentiality and use data only for our purposes.</li>
                    <li>Legal Requirements: We may disclose information if required by law, regulation, or to protect our rights, property, or safety, or that of others.</li>
                  </ul>
                  <p className="text-gray-700 text-base leading-relaxed">
                ...
                <div className="space-y-4">
                  <h3 className="text-xl font-semibold text-red-600">User Rights and Choices</h3>
                  <p className="text-gray-700 text-base leading-relaxed">
                    You have the following rights regarding your information:
                  </p>
                  <ul className="list-disc pl-6 space-y-1 text-gray-700 text-sm leading-relaxed">
                    <li>Access: Request details of any data we hold about you (if any).</li>
                    <li>Correction: Request correction of inaccurate data.</li>
                    <li>Deletion: Request deletion of data, subject to legal retention periods.</li>
                    <li>Opt-Out: Disable analytics collection if supported by the app (e.g., via settings, if implemented).</li>
                  </ul>
                  <p className="text-gray-700 text-base leading-relaxed">
                    For any privacy-related questions or to exercise these rights, contact us at <a href="mailto:Apps@Giolynx.org" className="text-blue-600 hover:text-blue-800 underline font-medium">Apps@Giolynx.org</a>. We will respond promptly to address your concerns. For EEA users, you may also contact our Data Protection Officer at the same email or lodge a complaint with your local data protection authority.
                  </p>
                </div>

                <div className="space-y-4">
                  <h3 className="text-xl font-semibold text-red-600">International Data Transfers</h3>
                  <p className="text-gray-700 text-base leading-relaxed">
                ...
                <div className="space-y-4">
                  <h3 className="text-xl font-semibold text-red-600">Children's Privacy</h3>
                  <p className="text-gray-700 text-base leading-relaxed">
                    Information Access Hub is not directed to children under 13. We do not knowingly collect data from children. If we become aware of such collection, we will delete the data and terminate the account (if applicable). Parents or guardians should contact us to report any concerns.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <h3 className="text-xl font-semibold text-red-600">Changes to This Privacy Policy</h3>
                  <p className="text-gray-700 text-base leading-relaxed">
                ...
                <div className="space-y-4">
                  <h3 className="text-xl font-semibold text-red-600">Compliance with Laws</h3>
                  <p className="text-gray-700 text-base leading-relaxed">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-700 text-base leading-relaxed">
                    For questions, concerns, or to exercise your rights, please contact us at <a href="mailto:Apps@Giolynx.org" className="text-blue-600 hover:text-blue-800 underline font-medium">Apps@Giolynx.org</a>. You may also write to us at GiolynxApps, Toronto, ON, Canada.
                  </p>
                </div>
              </div>
